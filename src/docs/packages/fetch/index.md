---
title: Fetch
description: The type-safe wrapper for Fetch API— with production-grade resilience.
published: true
...
- Use smart backoff with jitterFactor to prevent thundering herd problems
